...
//        }
        ...
        $data['protocol'] = $request->protocolVersion();
//        $data['protocol'] = $request->connection->protocol;

        $url = 'upload\image\20230719\8ee8a6aa52efd29dc60717643b63494e.jpg';
        $data['url'] = getResource($url);
